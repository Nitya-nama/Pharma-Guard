  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 pb-16">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="inline-flex items-center space-x-2 px-3 py-1 bg-purple-50 text-purple-700 rounded-full text-xs font-bold border border-purple-200 mb-2">
        ...
        <button
          ...
          disabled={refreshing}
          className="inline-flex items-center justify-center px-5 py-2.5 bg-white border border-slate-200 text-slate-700 font-bold rounded-xl shadow-xs hover:bg-slate-50 disabled:opacity-50 transition-all shrink-0"
        >
          <HiRefresh className={`w-4 h-4 mr-2 text-blue-600 ${refreshing ? 'animate-spin' : ''}`} />
              ...
              <div className="h-72 w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={topGenes} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                    <XAxis dataKey="gene" tick={{ fontSize: 12, fill: '#64748b', fontWeight: 600 }} />
                    <YAxis tick={{ fontSize: 12, fill: '#64748b' }} />
                    <Tooltip contentStyle={{ backgroundColor: '#0f172a', borderRadius: '12px', color: '#fff' }} />
