...
class PredictionRequestSchema(Schema):
    ...
    primary_gene = fields.String(allow_none=True)

    primary_variant = fields.String(allow_none=True)

    primary_phenotype = fields.String(allow_none=True)

    primary_evidence = fields.String(allow_none=True)
